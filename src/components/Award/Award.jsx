...
const Award = () => {
    return (
        <div className='text-center py-10'>
            <h2 className='text-2xl font-semibold lg:font-bold lg:text-4xl'>OUR AWARD ACHIEVEMENTS</h2>
            <p className='px-6 my-4'>We are honoured to recieve International acknowledment and rewards </p>
